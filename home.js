...
let buttonSouthEcoMode = document.querySelector(
  "div.home-south-block > .button-mode-eco"
);
let buttonSouthMainMode = document.querySelector(
  "div.south-block-buttons > .button-mode-main"
);
let buttonSouthWhiteMode = document.querySelector(
  "div.south-block-buttons > .button-mode-white"
);
let buttonSouthWhiteMixMode = document.querySelector(
  "div.south-block-buttons > .button-mode-white-mix"
);
let buttonSouthLightboxMode = document.querySelector(
  "div.south-block-buttons > .button-mode-lightbox"
);
let buttonSouthWhitePulseMode = document.querySelector(
  "div.south-block-buttons > .button-mode-white-pulse"
);
let buttonSouthColorDynamicMode = document.querySelector(
  "div.south-block-buttons > .button-mode-color-dynamic"
);
let buttonSouthVioletMode = document.querySelector(
  "div.south-block-buttons > .button-mode-violet"
);
let buttonSouthLogotypesMode = document.querySelector(
  "div.south-block-buttons > .button-mode-logotypes"
);
let buttonsSouth = document.querySelector(".south-block-buttons");

let buttonNorthEcoMode = document.querySelector(
  "div.home-north-block > .button-mode-eco"
);
let buttonNorthMainMode = document.querySelector(
  "div.north-block-buttons > .button-mode-main"
);
let buttonNorthWhiteMode = document.querySelector(
  "div.north-block-buttons > .button-mode-white"
);
let buttonNorthWhiteMixMode = document.querySelector(
  "div.north-block-buttons > .button-mode-white-mix"
);
let buttonNorthLightboxMode = document.querySelector(
  "div.north-block-buttons > .button-mode-lightbox"
);
let buttonNorthWhitePulseMode = document.querySelector(
  "div.north-block-buttons > .button-mode-white-pulse"
);
let buttonNorthSunsetMode = document.querySelector(
  "div.north-block-buttons > .button-mode-sunset"
);
let buttonNorthAutumnMode = document.querySelector(
  "div.north-block-buttons > .button-mode-autumn"
);
let buttonNorthLogotypesMode = document.querySelector(
  "div.north-block-buttons > .button-mode-logotypes"
);
let buttonNorthVioletMode = document.querySelector(
  "div.north-block-buttons > .button-mode-violet"
);
...
function sendManualMode(bool) {
  ...
  putData(url, valueBlockData).catch((error) =>
...
let buttonsSouthAll = document.querySelectorAll(
  "div.home-south-block .button-mode"
);
let buttonsNorthAll = document.querySelectorAll(
  "div.home-north-block .button-mode"
);
...
async function fetchSouthModeUpdate_NEW() {
  ...
  const block_S_ColorDynamicId =
    block_S_ColorDynamic["Home_S_Color_dynamic_Fb-id"];
  ...
  let block_S_WhitePulseState = await getValueBlockOutportDataById(
    block_S_WhitePulseId
  );
  let block_S_WhiteMixState = await getValueBlockOutportDataById(
    block_S_WhiteMixId
  );
  let block_S_ColorDynamicState = await getValueBlockOutportDataById(
    block_S_ColorDynamicId
  );
  let block_S_EcoState = await getValueBlockOutportDataById(block_S_EcoId);
  let block_S_VioletState = await getValueBlockOutportDataById(
    block_S_VioletId
  );
  let block_S_LightboxState = await getValueBlockOutportDataById(
    block_S_LightboxId
  );
  let block_S_LogotypesState = await getValueBlockOutportDataById(
    block_S_LogotypesId
  );
...
async function fetchNorthModeUpdate_NEW() {
  ...
  let block_N_WhitePulseState = await getValueBlockOutportDataById(
    block_N_WhitePulseId
  );
  let block_N_WhiteMixState = await getValueBlockOutportDataById(
    block_N_WhiteMixId
  );
  let block_N_SunsetState = await getValueBlockOutportDataById(
    block_N_SunsetId
  );
  let block_N_AutumnState = await getValueBlockOutportDataById(
    block_N_AutumnId
  );
  let block_N_EcoState = await getValueBlockOutportDataById(block_N_EcoId);
  let block_N_VioletState = await getValueBlockOutportDataById(
    block_N_VioletId
  );
  let block_N_LightboxState = await getValueBlockOutportDataById(
    block_N_LightboxId
  );
  let block_N_LogotypesState = await getValueBlockOutportDataById(
    block_N_LogotypesId
  );
